    ...
    <section class="block1 block1-buy">
        <div class="container">
            <div class="block1-wrap">
                <div class="head-schemes">СХЕМЫ ВОССТАНОВЛЕНИЯ ВОЛОС И УХОД ЗА ПОВРЕЖДЕННЫМИ ВОЛОСАМИ</div>
                    <div class="row">
                        <div class="col-md-3">
                            <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/damaged-hair.jpg" width="100%" alt="">
                        </div>
                        <div class="col-md-9">
                            <div class="schemes-header">Кому подойдет:</div>
                            <p>Если волосы повреждены, не важно чем, окрашиванием, плойками или просто неправильным уходом. Под лечением и восстановлением волос всегда подразумевается реставрация, так как волосы не живая ткань и вылечить ее невозможно и вернуть прежнее качество волос тоже, однако привести поврежеднные волосы в порядок можно.</p>

                            <div class="schemes-header">Содержание:</div>
                            <p>
                                <i class="fa fa-play" style="color: black; padding-right: 0; font-size: 14px" aria-hidden="true"></i> Как вернуть здоровье волосам. <br>
                                <i class="fa fa-play" style="color: black; padding-right: 0; font-size: 14px" aria-hidden="true"></i> Какие этапы возвращения здоровья волосам. <br>
                                <i class="fa fa-play" style="color: black; padding-right: 0; font-size: 14px" aria-hidden="true"></i> 3 схемы лечения, 3 схемы ухода за поврежеденными волосами. <br>
                                <i class="fa fa-play" style="color: black; padding-right: 0; font-size: 14px" aria-hidden="true"></i> Как понять подходят ли вам средства. <br>
                                <i class="fa fa-play" style="color: black; padding-right: 0; font-size: 14px" aria-hidden="true"></i> Списки с примерами и названиями средств, ссылками где купить наиболее выгодно с указанием цен упорядоченные от самых бюджетных до профессиональных.<br>
                                <i class="fa fa-play" style="color: black; padding-right: 0; font-size: 14px" aria-hidden="true"></i> Памятку - как правильно использовать данные средства. <br>
                                <i class="fa fa-play" style="color: black; padding-right: 0; font-size: 14px" aria-hidden="true"></i> Памятку - правильный порядок нанесения.
                            </p>

                            <div class="schemes-header">Количество страниц:</div>
                            <p>26 стр. в pdf файле.</p>
            ...
            <div class="block1-wrap">
                ...
                <div class="block1-text block-pay">
                    ...
                    <div class="block-pay-price">
                        <span class="price">Цена: 189 руб. / 3$</span>
                        <br>
                    ...
                    <div class="pay">
                        ...
                        <form method="POST" action="https://money.yandex.ru/quickpay/confirm.xml">
                            ...
                            <input type="hidden" name="label" value="damaged-hair">
                            <input type="hidden" name="need-email" value="true">
                            <input type="hidden" name="quickpay-form" value="donate">
                            <input type="hidden" name="targets" value="Восстановление">
