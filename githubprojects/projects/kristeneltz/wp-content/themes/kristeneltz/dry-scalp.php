    ...
    <section class="block1 block1-buy">
        <div class="container">
            <div class="block1-wrap">
                <div class="head-schemes">СХЕМЫ УХОДА ЗА СУХИМ ТИПОМ КОЖИ ГОЛОВЫ</div>
                    <div class="row">
                        <div class="col-md-3">
                            <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/dry-scalp.jpg" width="100%" alt="">
                        </div>
                        <div class="col-md-9">
                            <div class="schemes-header">Кому подойдет:</div>
                            <p>Если голова становится долго жирной, а мыть приходится примерно раз в 4-7 дней, также может наблюдаться сухость, стянутость кожи головы и чувствительность.</p>

                            <div class="schemes-header">Содержание:</div>
                            <p>
                                <i class="fa fa-play" style="color: black; padding-right: 0; font-size: 14px" aria-hidden="true"></i> Два варианта схемы ухода за сухим типом <br>
            ...
            <div class="block1-wrap">
                ...
                <div class="block1-text block-pay">
                    ...
                    <div class="block-pay-price">
                        <span class="price">Цена: 99 руб. / 1,57$</span>
                        <br>
                    ...
                    <div class="pay">
                        ...
                        <form method="POST" action="https://money.yandex.ru/quickpay/confirm.xml">
                            ...
                            <input type="hidden" name="label" value="dry-scalp">
                            <input type="hidden" name="need-email" value="true">
                            <input type="hidden" name="quickpay-form" value="donate">
                            <input type="hidden" name="targets" value="Сухой тип">
